            ...
            <div className="mt-4 space-x-4 flex">
                ...
                <Tooltip content={'Early access version, still subject to testing.'} >
                    <SelectableCard className="w-36 h-40" title="VS Code" selected={defaultIde === 'code-latest'} onClick={() => actuallySetDefaultIde('code-latest')}>
                        ...
                        <span className="mt-2 ml-2 self-center rounded-xl py-0.5 px-2 text-sm bg-orange-100 text-orange-700 dark:bg-orange-600 dark:text-orange-100 font-semibold">INSIDER</span>
                    </SelectableCard>
                </Tooltip>
            </div>
